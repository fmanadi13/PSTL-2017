...
from pylatex.base_classes import ContainerCommand, Command
...
class Head(ContainerCommand):
    ...
    def __init__(self, position=None, *, data=None):
        ...
        if self.position == 'L':
            self._latex_name= 'lhead'
        elif self.position == 'R':
            self._latex_name= 'rhead'
        elif self.position == 'C':
            self._latex_name= 'chead'

        super().__init__(data=data)


class Foot(ContainerCommand):
    ...
    def __init__(self, position=None, *, data=None):
        ...
        self.position = position
        if self.position == 'L':
            self._latex_name= 'lfoot'
        elif self.position == 'R':
            self._latex_name= 'rfoot'
        elif self.position == 'C':
            self._latex_name= 'cfoot'

...
from pstl.org.pylatex.utils import NoEscape
...
class Checkboxes(List):
    """A class that represents a checkboxes list."""
    ...
    def __init__(self, *, options=None, **kwargs):
        ...
        self.packages.add(Package("amsmath"))
        self.packages.add(Package("amssymb"))
    ...
    def add_item(self, isChecked, s):
        ...
        ----
        isChecked: bool
            Determines wether the checkbox is checked or not.
        s: str or `~.LatexObject`
            The item itself.
        """
